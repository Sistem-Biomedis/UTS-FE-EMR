...
const AddPasien = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await axios.post('http://localhost:5000/pasien', formData);
  ...
  return (
    <div className="max-w-lg mx-auto p-6 bg-white shadow-lg rounded-lg mt-8">
      ...
      {error && <div className="text-red-500 text-center mb-4">{error}</div>} {/* Show error message if any */}
      <form onSubmit={handleSubmit}>
        ...
        <div className="mb-4">
          <label htmlFor="riwayat_medis" className="block text-sm font-medium text-gray-700">Riwayat Medis</label>
          <textarea
            name="riwayat_medis"
            id="riwayat_medis"
        ...
        <div className="mb-4">
          <label htmlFor="golongan_darah" className="block text-sm font-medium text-gray-700">Golongan Darah</label>
          <select
            name="golongan_darah"
            id="golongan_darah"
